...
import com.jiwon.memo.common.FileManagerService;
import com.jiwon.memo.common.PermissionInterceptor;
...
public class WebMVCController implements WebMvcConfigurer{
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		.excludePathPatterns("/user/signout", "/static/**", "/images/**");  //인터셉터 거치지 않아도 되는 페이지
